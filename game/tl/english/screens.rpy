...
translate english strings:
    ...
    new "Advance the dialog and activate the interface."
    ...
    new "Activates/deactivates the dialogue break."
    ...
    new "Move on to the next dialogue."
